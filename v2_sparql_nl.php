<?php
	...
	?p <http://purl.org/collections/w4ra/speakle/voicelabel_nl>	?personvoice.
	?o <http://purl.org/collections/w4ra/radiomarche/quantity> ?quantu . 
 	?quantu <http://purl.org/collections/w4ra/speakle/voicelabel_nl>	?quant.
#       ?quantu <http://www.w3.org/2000/01/rdf-schema#label>  ?quant.
	?o <http://purl.org/collections/w4ra/radiomarche/unit_measure> ?measu . 
	?measu <http://purl.org/collections/w4ra/speakle/voicelabel_nl>	?meas.
...
#        ?priceu  <http://www.w3.org/2000/01/rdf-schema#label> ?price . 	
	?priceu <http://purl.org/collections/w4ra/speakle/voicelabel_nl>	?price.
	?o <http://purl.org/collections/w4ra/radiomarche/currency> ?currencyu.
	?currencyu <http://purl.org/collections/w4ra/speakle/voicelabel_nl>	?currency.
	} 
        LIMIT 3";
	...
	print "<audio src=\"http://semanticweb.cs.vu.nl/amalgame/voicestest/VXMLtest/audio/dutch_offerings.wav\"/> " .$product ."\n" ;
	#Hier volgt een lijst van de drie laatste aanbiedingen voor ".$product ."\n" ;	
...
#	 if ($meas=="kg"){ $meas = "kilos";}
	...
	print "<audio src=\"" .$personvoice ."\"/> bead " ;
	print "<audio src=\"" .$quant ."\"/> ";
	print "<audio src=\"" .$meas ."\"/> vore ";
